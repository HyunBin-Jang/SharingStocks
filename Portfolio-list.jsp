				...
				<div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Member's 포트폴리오</h6>
                        </div>     
					...
					%>
                                    ...
                                    <tr>
											...
											<td align="center" width= "75"> <%= rs.getString("useraName")%></td>									
											<td align="center" width="275"><a href="sharePortfolio.jsp?someoneID=<%=rs.getString("userID")%>">포트폴리오 보기</a></td>																					
											<td align="center" width="175"><%= rs.getString("userEmail") %></td>
									</tr>									
											<% rownum--;} %>	
									</tbody>														
								</table>										                                            

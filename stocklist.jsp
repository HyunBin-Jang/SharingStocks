        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">등록 주식 목록</h1>
                    <p class="mb-4">본 사이트에서 제공하는 kospi 200 주식들의 상세정보를 확인할 수 있는 페이지입니다</p>
				<br><br>
...
<!-- 					    </div> -->
						...
						<div id="board">
							<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd; table-layout:fixed; width:47%; float:left">
								<tr>
									<th style="background-color: #eeeeee; text-align: center;">주식명</th>					
									<th style="background-color: #eeeeee; text-align: center;">주가</th>
								</tr>
			...
			<%
					        	...
					        	%>
					        	<tr>
					        		<td><a href="stockinfo.jsp?code=<%=Code.get(((pageNumber - 1 )* 20) + i) %>">
					        		<%= Name.get(((pageNumber - 1 )* 20) + i) %></a></td>
					        		<td><%= Juga.get(((pageNumber - 1 )* 20) + i) %></td>
					        		<%} %>
								</tr>
					    	</table>
					    </div>
					    ...
					    <div id="board">
							<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd; table-layout:fixed; width:47%; float:right">
								<tr>
									<th style="background-color: #eeeeee; text-align: center;">주식명</th>					
									<th style="background-color: #eeeeee; text-align: center;">주가</th>
								</tr>
			...
			<%
					        	...
					        	%>
					        	<tr>
					        		<td><a href="stockinfo.jsp?code=<%=Code.get(((pageNumber - 1 ) * 20) + 10 + i) %>">
					        		<%= Name.get(((pageNumber - 1 )* 20) + 10 + i) %></a></td>
					        		<td><%= Juga.get(((pageNumber - 1 )* 20) + 10 + i) %></td>
					        		<%} %>
								</tr>
					    	</table>
					    </div>
...
<%-- 					         <li  <c:if test="${startPage != 1}"> class="page-item disabled"    </c:if>> --%>
<%--                                 <a class="page-link" href="BoardListAction.bo?page=${startPage-1}" tabindex="-1" aria-disabled="true">이전</a> --%>
<!--                             </li> -->
					    <br>
					    <div id="pageForm" class="pt-3" style="position: absolute; top: 800px; left: 44.44%" >                            
                            <ul class="pagination justify-content-center mb-0">
								<c:forEach begin="1" end="10" var="idx">
									<li class="page-item">
										<a class="page-link" href="stocklist.jsp?pageNumber=${idx}"> ${idx} </a>
									</li>
								</c:forEach>
                            </ul>
					    </div>

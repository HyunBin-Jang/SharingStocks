...
<head>
    ...
    <title>Member's Portfolio</title>
	...
	<%  
		...
		String someoneID;
		someoneID = (String)request.getParameter("someoneID");
		...
		try{
			...
			sql = "select * from portfolio where id = '" + someoneID + "'";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><%=someoneID%>님의 포트폴리오</h1>
